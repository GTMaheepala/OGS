...
@WebServlet("/AccountDeleteEmployeeServlet")
public class AccountDeleteEmployeeServlet extends HttpServlet {
	...
	if(isTrue == true) {
		...
		RequestDispatcher dispacher = request.getRequestDispatcher("EmployeeGetAllServlet");
