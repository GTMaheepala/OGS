...
public class checkoutController {
	    ...
	    //update data
	    public static boolean updatedata(int id, String country, String streetName, String city, String district, String province, String custName, int mobile, String NIC, String cName, String cNo, String eDate, int CVV) {
	    	try {
	    		// DB Connection
		        con = (Connection) DB_Connection.getConnection();
		        stmt = (Statement) con.createStatement();
	            ...
	            //sql query
	            String  sql = "UPDATE checkout SET country='"+country+"', streetName ='"+streetName+"',city='"+city+"',district='"+district+"',province='"+province+"',custName='"+custName+"',mobile='"+mobile+"',NIC='"+NIC+"', cName='"+cName+"', cNo='"+cNo+"', eDate='"+eDate+"', CVV='"+CVV+"';"
	            		+ "WHERE id='"+id+"'";
