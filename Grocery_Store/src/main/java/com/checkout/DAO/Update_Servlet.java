...
public class Update_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        isTrue = checkoutController.updatedata(id, country, streetName, city, district, province, custName, mobile, email, NIC, cName, cNo, eDate, CVV);
        
        if(isTrue == true) {
        	List<checkout> checkoutdetails = checkoutController.getById(idStr);
